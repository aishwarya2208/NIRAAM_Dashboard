...
import {RiNotification3Line, RiNotificationLine} from 'react-icons/ri'
...
const Navbar = () => {
  ...
  return (
    <div className = "flex justify-between p-2 md:mx-6 relative text">
