...
import { AiOutlineCalendar, AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock, AiOutlineHome,AiFillFire } from 'react-icons/ai';
import { FiShoppingBag, FiEdit, FiPieChart, FiBarChart, FiCreditCard, FiStar, FiShoppingCart } from 'react-icons/fi';
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsFillTrash3Fill } from 'react-icons/bs';
import { MdOutlineHealthAndSafety,MdNotificationImportant } from 'react-icons/md';
import {LuMilk} from "react-icons/lu";
import {GiStomach,GiPointing} from "react-icons/gi";
...
export const barChartData1 = [
  { x: "Milk Fat %", y: 3.4 },
  { x: "Lactose %", y: 4.86 },
  { x: "Total Protein %", y: 2.53 },
  { x: "Milk Fatty Acid %", y: 18 },
  { x: "Solid Non Fat %", y: 9.70 },
  { x: "pH", y: 6.5 },
];
...
export const LinePrimaryXAxis = {
  valueType: 'DateTime',
  labelFormat: 'dd-MM-yyyy', // Set the label format to 'Quarter'
  intervalType: 'Days', // Assuming your data has monthly intervals
  edgeLabelPlacement: 'Shift',
  majorGridLines: { width: 0 },
  background: 'white',
  labelStyle: {
  ...
  minimum: new Date(2023, 10, 5), // November is represented as 10 in JavaScript Date object
  maximum: new Date(2023, 10, 8), // November is represented as 10 in JavaScript Date object
...
export const links = [
...

  {
    ...
    links: [
      {
        name: 'Wellness & Disease Management',
        icon: <MdOutlineHealthAndSafety />,
        linktitle:'Wellness'
      },
      {
        name: 'Milk Parameters',
        icon: <LuMilk />,
        linktitle: 'milk-parameters'
      },
      {
        name: 'Rumen Health',
        icon: <GiStomach />,
      ...
      {
        name: 'Pregnancy and Estrous Health',
        icon: <GiCow />,
        linktitle: 'pregnancy'
      },
      /*{
...
export const earningData = [
  {
    ...
    amount: '21st Nov',
    percentage: '',
    title: 'Predicted NEXT Heat starts',
    iconColor: 'red',
    iconBg: '#E5FAFB',
    pcColor: 'red-600',
  },
...
export const lineChartData = [
  [
    { x: new Date(2023, 10, 5), y: 4.9 },
    { x: new Date(2023, 10, 6), y: 4.5 },
    { x: new Date(2023, 10, 7), y: 4.5 },
    { x: new Date(2023, 10, 8), y: 5.0 },
  ],
  [
    { x: new Date(2023, 10, 5), y: 5.0 },
    { x: new Date(2023, 10, 6), y: 6.0 },
    { x: new Date(2023, 10, 7), y: 5.0 },
    { x: new Date(2023, 10, 8), y: 5.0 },
  ],
  [
    { x: new Date(2023, 10, 5), y: 5.2 },
    { x: new Date(2023, 10, 6), y: 5.2 },
    { x: new Date(2023, 10, 7), y: 6.0 },
    { x: new Date(2023, 10, 8), y: 6.0 },
  ],
  [
    { x: new Date(2023, 10, 5), y: 7.0 },
    { x: new Date(2023, 10, 6), y: 6.0 },
    { x: new Date(2023, 10, 7), y: 6.0 },
    { x: new Date(2023, 10, 8), y: 5.8 },
  ],
];
...
export const lineCustomSeries = [
  { dataSource: lineChartData[0],
    ...
    name: '1',
    width: '2',
    marker: { visible: true, width: 10, height: 10, color:'white' },
    type: 'Line' },
...
export const pieChartData = [
  { x: 'Milk Urea Nitrogen', y: 16, text: 'Milk Urea Nitrogen: 16%' },
    { x: 'Lactose', y: 4.85, text: 'Lactose: 4.85%', fill: '#0450C2' },
    { x: 'Crude Protein', y: 0.59, text: 'Crude Protein: 0.59%' },
    { x: 'True Protein', y: 2.53, text: 'True Protein: 2.53%' },
    { x: 'Fat', y: 3.4, text: 'Fat: 3.4%' },
    { x: 'Casein', y: 2.6, text: 'Casein: 2.6%' } // Different shade of blue
];
